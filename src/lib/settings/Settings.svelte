...
import { 
    ...
    settings_space_slot, settings_ground_slot, settings_rarity, settings_boundto, settings_boundwhen
    } from '$lib/stores';
...
<style>
    ...
    .settings_content {
        overflow-y: auto;
        height: calc(100vh - 100vw*(143/1920) - 5*var(--gutter) - 1.2*var(--aside-image-width));
